    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float node_7374 = 0.0;
                float node_3716 = 1.0;
                float3 node_6363 = clamp(
                    (round((saturate(
                            (node_7374 + ((pow(_MainTex_var.rgb, _GammaCorrection) - node_7374) * ((node_3716 - (
                                node_3716 /
                                (node_4955 - node_3716))) - node_7374)) / (node_3716 - node_7374))) * node_4955)) /
                        node_4955), 0, 0.999).rgb;
                float node_4323 = node_6363.b;
                float node_1457 = (1.0 / 3.0);
                float2 node_3997 = clamp(
                    ((1.0 / (node_4955 * node_1499)) * (float2(node_6363.r, node_6363.g) * node_4955)), 0, 0.999);
                ...
                float2 node_429 = ((frac((node_2380 * (node_5141 / _DitherTileSize))) / float2(_DitheringLevels, 1.0)) +
                    float2((floor((node_372.r * _DitheringLevels)) / _DitheringLevels), 0.0)); // DitherPosition
                ...
                float3 emissive = lerp((node_5834_if_leA * node_6865.rgb) + (node_5834_if_leB * node_7834.rgb),
                                       node_7834.rgb, node_5834_if_leA * node_5834_if_leB);
