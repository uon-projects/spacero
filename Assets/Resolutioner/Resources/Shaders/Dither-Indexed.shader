    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float node_3461 = pow(Lightness(_MainTex_var.r, _MainTex_var.g, _MainTex_var.b), _GammaCorrection);
                // Correct gamma
                ...
                float2 node_9155 = ((frac((node_7898 * (node_656 / _DitherTileSize))) / float2(_DitheringLevels, 1.0)) +
                    float2((((floor((node_3461 * node_3474)) / node_3474) - node_3657) * _DitheringLevels), 0.0));
                ...
                float3 emissive = lerp((node_1015_if_leA * node_3472.rgb) + (node_1015_if_leB * node_6208.rgb),
                                       node_6208.rgb, node_1015_if_leA * node_1015_if_leB);
