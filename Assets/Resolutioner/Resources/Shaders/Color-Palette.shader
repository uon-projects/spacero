    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float2 node_5983 = (((((floor((node_4947 * i.uv0)) / node_4947) / node_8640) + float2(
                        ((round((clamp(_MainTex_var.b, 0, 0.9999999) * node_9902)) / node_9902) * node_9902), 0.0)) /
                    node_6847) + (((1.0 / node_8640) / node_6847) * (float2(_MainTex_var.r, _MainTex_var.g) * (node_9902
                    -
                    1.0))));
