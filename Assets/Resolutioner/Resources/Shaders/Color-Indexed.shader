...
Shader "Pixelatto/Color-Indexed"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma target 3.0
            uniform sampler2D _Palette16;
            uniform float4 _Palette16_ST;
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float2 node_2047 = float2(
                    pow(saturate((_LightOffset + Lightness(node_2347.r, node_2347.g, node_2347.b))), _GammaCorrection),
                    0.0);
