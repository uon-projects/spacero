    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float3 emissive = (floor((_MainTex_var.rgb * 3.0)) / 2.0);
