...
Shader "Pixelatto/Pixel-Pixelate"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                ////// Lighting:
                ////// Emissive:
                float node_779 = 0.5; // Half pixel offset
                float2 node_7945 = float2(_ScreenParams.r, _ScreenParams.g);
                float2 node_5411 = (node_7945 / _Zoom); // SD Resolution
                float2 node_6113 = floor((node_5411 * i.uv0));
                float2 node_15 = (((node_779 + node_6113) + floor(((node_7945 - node_5411) / 2.0))) / node_7945);
