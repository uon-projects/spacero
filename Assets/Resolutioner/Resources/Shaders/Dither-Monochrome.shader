    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR
            {
                ...
                float2 node_9155 = ((frac((node_7898 * (node_656 / _DitherTileSize))) /
                    float2(_DitheringLevels, node_3390)) + float2(
                    floor(pow(Lightness(_MainTex_var.r, _MainTex_var.g, _MainTex_var.b), _GammaCorrection) * node_3520)
                    / (node_3520 - 1), 0.0));
                ...
                float3 emissive = lerp((node_1015_if_leA * _DarkColor.rgb) + (node_1015_if_leB * _LightColor.rgb),
                                       _DarkColor.rgb, node_1015_if_leA * node_1015_if_leB);
